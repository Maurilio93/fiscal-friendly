      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Soluzioni rapide e accessibili per cittadini, imprese e
            professionisti
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-primary-foreground/90 max-w-3xl mx-auto">
            Zero burocrazia per te, ci pensiamo noi. Supporto professionale per
            problemi fiscali, legali, lavorativi e finanziari.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div className="flex flex-col items-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Costi accessibili, niente sorprese
              </p>
            </div>
            <div className="flex flex-col items-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Esperti qualificati al tuo servizio
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Non perdere altro tempo con la burocrazia. I nostri esperti sono qui
            per aiutarti.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/contatti">
