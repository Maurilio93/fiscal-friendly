      ...
      <section className="bg-[#0D3B66] text-primary-foreground py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-primary-foreground/90">
            Il tuo partner di fiducia per soluzioni fiscali, legali e
            professionali
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Supportiamo chi deve affrontare problemi fiscali, legali,
              lavorativi o finanziari
            </h2>
            <p className="text-xl text-muted-foreground leading-relaxed">
              Crediamo che nessuno dovrebbe sprecare tempo prezioso e denaro per
              navigare nella complessità burocratica. La nostra missione è
              semplice: <strong>zero burocrazia per te, ci pensiamo noi</strong>
              .
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16">
            <Card className="shadow-elegant hover:shadow-glow transition-smooth">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Rendere accessibili servizi professionali di qualità,
                  eliminando le complessità burocratiche e offrendo soluzioni
                  rapide a costi trasparenti per cittadini, imprese e
                  professionisti.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-elegant hover:shadow-glow transition-smooth">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Trasparenza, rapidità e professionalità sono i pilastri del
                  nostro lavoro. Crediamo in un servizio che metta al centro le
                  persone e le loro esigenze concrete.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Professionisti qualificati con anni di esperienza in ambito
                fiscale, legale e consulenziale pronti ad assisterti.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Standard elevati di qualità e precisione in ogni servizio, con
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
            Non siamo solo consulenti, siamo i tuoi partner nella risoluzione di
            problemi complessi. Trasformiamo la burocrazia in soluzioni
            semplici, permettendoti di concentrarti su quello che conta davvero:
          ...
          <Card className="shadow-elegant bg-gradient-card text-left">
            <CardContent className="p-8">
              <blockquote className="text-lg italic text-muted-foreground mb-4">
                "Finalmente un servizio veloce e chiaro. Non ho più il problema
                di capire la burocrazia, loro si occupano di tutto e io ricevo
                solo la soluzione."
              </blockquote>
              <cite className="text-sm font-medium">
                — Maria R., Cliente dal 2023
              </cite>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="py-20 bg-primary text-primary-foreground px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 text-primary-foreground/90">
            Scopri come possiamo semplificare la tua vita e risolvere i tuoi
